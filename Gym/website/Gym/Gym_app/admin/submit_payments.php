...
VALUES ('$memid','$full_name','$mem_type','$date','$total','$paid','$expiry','$invoice','$name_type','$bal','$exp_time','yes')");
    echo "<head><script>alert('Payment Added:$full_name');</script></head></html>";
...
<!doctype html>
	...
	<body>
		<header>
			<a href="index.php?vis=payments"><h1>Invoice (Payments)</h1></a>
      <address>
         <p>Orange Fitness</p>
    ...
    <canvas id="canvasTarget"></canvas> </span>
			...
			<span><img alt="" src="../../img/logo.png" width="250" height="150">
		</header>
