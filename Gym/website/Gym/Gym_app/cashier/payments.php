					    ...
					    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
					        ...
					        if (mysqli_affected_rows($con) == 1) {
					            while ($row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC)) {
					                ...
					                echo "<td><form action='?vis=make_payments' method='post'><input type='hidden' name='name' value='" . $msgid . "'/><input type='submit' value='Add Payment ' class='btn btn-info'/></form></td></tr>";
					                $msgid = 0;
					            }
					        }
					    }
