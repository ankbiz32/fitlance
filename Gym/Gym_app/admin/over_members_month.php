	...
	<table class="table table-bordered datatable" id="table-12">
		...
		<tbody>
		    <?php
			$query  = "select * from user_data WHERE joining BETWEEN '$from2' AND '$to2' AND is_active='1' AND is_deleted='0' AND branch_id = '$_SESSION[branch_id]' ORDER BY joining ASC";
