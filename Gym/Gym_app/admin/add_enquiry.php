...
<form action="enquiry_submit.php" method="POST" class="form-horizontal form-groups-bordered">
    ...
    <div class="row">
      <div class="col-md-6 form-group"><label for="field-1" class="col-sm-3 control-label">Join Date / Follow Up Date :</label>					
    ...
    <div class="row">
      <div class="col-md-6 form-group"><label for="field-1" class="col-sm-3 control-label">Membership Type :</label>					
        <div class="col-sm-7"><select name="mem_type" data-rule-required="true" id="plan" onchange="plan_Details(this.value)" class="form-control">
				<option value="">-- Please select --</option>
				<?php
    ...
    <div class="col-md-12 form-group">		
      <div class="col-sm-offset-1 col-sm-11">
			  ...
			  <button type="submit" class="btn btn-primary pull-right"  name="follow_up" value="submit" style="margin-right: 5px;">Follow Up</button>
