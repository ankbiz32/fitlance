...
if (isset($_POST['name'])) {
  $invoice = $_POST['name'];
?>
    <h4 class="hed">Diet Payment</h4>
    <hr />
    <form action="bal_dietpay_submit.php" enctype="multipart/form-data" method="POST" role="form" class="form-horizontal form-groups-bordered">
	  <?php
		$query  = "select * from dietpayment WHERE invoice='$invoice'";
	  ...
	  <div class="form-group">
	    <label for="field-1" class="col-sm-3 control-label">Payment Date :</label>					
		  <div class="col-sm-5">
		    <input type="text" name="paiddate" id="textfield22" class="form-control datepicker" value="<?php echo $paid_date; ?>">
	      </div>
	  </div>
	  <div class="form-group">
	  ...
	  <div class="form-group"><label for="field-1" class="col-sm-3 control-label">Bank Name :</label>					
        <div class="col-sm-5"><select name="bank" id="bank" data-rule-required="true" class="form-control">
				<option value="">-- Please select --</option>
				<?php
